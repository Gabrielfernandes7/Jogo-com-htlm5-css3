function start(){
    ...
    //Música em loop
    musica.addEventListener("ended", function (){ musica.currentTime = 0; musica.onplay(); }, false);
    musica.play();
   ...
   function moveamigo() {
    ...
    function colisao() {
        ...
        var colisao5 = ($("#jogador").collision($("#amigo1")));
        var colisao1 = ($("#inimigo2").collision($("#amigo1")));
    ...
    function explosao1(inimigo1X, inimigo1Y) {
        ...
        $("#explosao1").css("background-image", "url(image/explosao.png)");
        var div = $("#explosao1");
        div.css("left", inimigo1Y);
